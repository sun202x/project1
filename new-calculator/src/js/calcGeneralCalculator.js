...
export default class CalcGeneralCalculator extends Calculator {
    ...
    onInitContents() {
        ...
        // >>>>>>>>>>>> MAIN Operator
        const percent = control
            .define("button", "percent")
            .label("%")
            .value("%")
            .type("operator")
        ...
        const clearAll = control
            .define("button", "clearAll")
            .label("C")
            .value("C")
            .type("clearAll")
            .onclick(this.onClick.bind(this))
        ...
        const backSapce = control
            .define("button", "backSapce")
            .label("<")
            .value("<")
            .type("clear")
            .onclick(this.onClick.bind(this))
        ...
        const fountain = control
            .define("button", "fountain")
            .label("½")
            .value("½")
            .type("operator")
            .onclick(this.onClick.bind(this))
        ...
        const squared = control
            .define("button", "squared")
            .label("제곱")
            .value("제곱")
            .type("operator")
            .onclick(this.onClick.bind(this))
        ...
        const division = control
            .define("button", "division")
            .label("/")
            .value("/")
            .type("operator")
            .onclick(this.onClick.bind(this))
        ...
        const number7 = control
            .define("button", "number7")
            .label("7")
            .value("7")
            .type("number")
            .onclick(this.onClick.bind(this))
        ...
        const number8 = control
            .define("button", "number8")
            .label("8")
            .value("8")
            .type("number")
            .onclick(this.onClick.bind(this))
        ...
        const number9 = control
            .define("button", "number9")
            .label("9")
            .value("9")
            .type("number")
            .onclick(this.onClick.bind(this))
        ...
        const multiply = control
            .define("button", "multiply")
            .label("*")
            .value("*")
            .type("operator")
            .onclick(this.onClick.bind(this))
        ...
        const number4 = control
            .define("button", "number4")
            .label("4")
            .value("4")
            .type("number")
            .onclick(this.onClick.bind(this))
        ...
        const number5 = control
            .define("button", "number5")
            .label("5")
            .value("5")
            .type("number")
            .onclick(this.onClick.bind(this))
        ...
        const number6 = control
            .define("button", "number6")
            .label("6")
            .value("6")
            .type("number")
            .onclick(this.onClick.bind(this))
        ...
        const number1 = control
            .define("button", "number1")
            .label("1")
            .value("1")
            .type("number")
            .onclick(this.onClick.bind(this))
        ...
        const number2 = control
            .define("button", "number2")
            .label("2")
            .value("2")
            .type("number")
            .onclick(this.onClick.bind(this))
        ...
        const number3 = control
            .define("button", "number3")
            .label("3")
            .value("3")
            .type("number")
            .onclick(this.onClick.bind(this))
        ...
        const plusMinus = control
            .define("button", "plusMinus")
            .label("+/-")
            .value("+/-")
            .type("operator")
            .onclick(this.onClick.bind(this))
        ...
        const number0 = control
            .define("button", "number0")
            .label("0")
            .value("0")
            .type("number")
            .onclick(this.onClick.bind(this))
